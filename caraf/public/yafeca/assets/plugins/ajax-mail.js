...
$(function () {
    ...
    $("#af-form .form-button").click(function () {
        ...
        var dataString = 'name=' + name + '&email=' + email + '&message=' + message + '&subject=' + message;
...
$(function () {
    ...
    $("#submit_btn_rf").click(function () {
        ...
        if (typeuser == "") {
            $("#af-form-rf label#typeuser_error_rf").show();
            $("#af-form-rf input#typeuser-rf").focus();
            return false;
        }
        ...
        var dataString = 'name=' + name + '&email=' + email + '&phone=' + phone + '&message=' + message + '&typeuser=' + typeuser;
        //alert (dataString);return false;
        ...
        $.ajax({
            ...
            data:dataString,
            success:function () {
                $('#af-form-rf').prepend("<div class=\"col-sm-12 \"><div class=\"alert alert-success fade in\"><button class=\"close\" data-dismiss=\"alert\" type=\"button\">&times;</button><strong>Nous avons enregistré votre inscription</strong><br>Nous vous contacterons merci</div></div>");
                $('#af-form-rf')[0].reset();
            }
        });
        return false;
