            ...
            <aside class="profile-info col-lg-9">
                <section class="panel">
                    <div class="bio-graph-heading">
                        <i class="fa fa-pencil-square" aria-hidden="true"></i> <b>Modification d'une page</b>
                    </div>
                    <div class="panel-body bio-graph-info">
                            ...
                            <aside class="profile-info col-lg-9">
                                <section class="panel">
                                    ...
                                    <div class="panel-body bio-graph-info">
                                        <form class="form-horizontal" enctype="multipart/form-data" method="post" action="<?php bs() ?>users/article/update_image_page/<?php echo $page_details->id ?>" role="form">
