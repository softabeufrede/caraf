        ...
        <div class="row">
            <aside class="profile-nav col-lg-3">
                <section class="panel">
                    ...
                    <!--                            </li>-->
                    <!--                            <li>-->
<!--                    <a href="--><?php //bs() ?><!--users/article/update_image_page/--><?php //echo $page_details->id ?><!--" class="btn btn-primary">-->
<!--                        Changer l'image-->
<!--                    </a>-->
                    <!--                            </li>-->
                    <!--                            <li>-->
            ...
            <aside class="profile-info col-lg-9">
                <section class="panel">
                    <div class="bio-graph-heading">
                        <i class="fa fa-pencil-square" aria-hidden="true"></i> <b>Modification d'image projet</b>
                    </div>
                    <div class="panel-body bio-graph-info">
                            ...
                            <aside class="profile-info col-lg-9">
                                <section class="panel">
                                    ...
                                    <div class="panel-body bio-graph-info">
                                        <form class="form-horizontal" enctype="multipart/form-data" method="post" action="<?php bs() ?>users/article/update_image_projet/<?php echo $page_details->id ?>" role="form">
                                            ...
                                            <div class="row">
                                                <div class="col col-md-6 pull-left">
                                                    <input type="file" name="projet_image">
                                                </div>
