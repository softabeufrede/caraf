...
<!--                            </li>-->
<!--                            <li>-->
                                <a href="<?php bs() ?>users/article/change_image_page/<?php echo $page_details->id ?>" class="btn btn-primary">
                                   Changer l'image
                                </a>
<!--                            </li>-->
<!--                            <li>-->
                ...
                <aside class="profile-info col-lg-9">
                    <section class="panel">
                        <div class="bio-graph-heading">
                            <i class="fa fa-pencil-square" aria-hidden="true"></i> <b>Modification de page</b>
                        </div>
                        <div class="panel-body bio-graph-info">
                            <form method="post" action="<?php bs() ?>users/article/edit_page/<?php echo $page_details->id ?>">
