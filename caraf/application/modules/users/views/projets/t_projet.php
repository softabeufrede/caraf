                ...
                <div class="col-sm-12">
                    <section class="panel">
                        <header class="panel-heading">
                            <i class="fa fa-users"></i><a href="#" class="">Liste des Projet</a>
				     ...
				     <span class="tools pull-right">
                        ...
                        <div class="panel-body">
                            ...
                            <table id="dtBasicExample" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
                                ...
                                <?php foreach($table_projets as $projet):?>
                                <tr>
                                    <td><?php  echo $projet->creation_date?></td>
                                    <td><?php  echo $projet->title?></td>
                                    <td><?php  echo $projet->lieu?></td>
                                    <td><?php coupeCourt($projet->content,50,$marge=10);?></td>
                                    <td><img src="   <?php bs() ?>uploads/<?php echo $projet->image ?>" alt="" width="125" height="85"></td>
                                    <td>
                                        <a href="<?= base_url('users/article/edit_projet')?>/<?= $projet->id ?>" class="btn btn-danger btn-sm"><i class="fa fa-pencil"></i></a>
                                    </td>
                                </tr>
                                <?php endforeach ?>
                                </tbody>
