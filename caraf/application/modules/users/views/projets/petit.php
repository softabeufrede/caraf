                ...
                <div class="col-sm-12">
                    <section class="panel">
                        <header class="panel-heading">
                            <i class="fa fa-users"></i><a href="<?= bs() ?>users/article/t_article" class="">Liste des projets</a>
<!--                            <a href="--><?//= bs('users/print_with_dompdf') ?><!--">-->
				     ...
				     <span class="tools pull-right">
                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" enctype="multipart/form-data" method="post" action="<?php bs() ?>users/article/page/t_page" role="form">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <select class="form-control" id="inlineFormCustomSelectPref">
                                            ...
                                            <option value="2">Petit Durable</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group row">
