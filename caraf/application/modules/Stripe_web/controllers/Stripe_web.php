    ...
    */
    public function index()
    {
        ...
        foreach ($data['users'] as $k => $user)
        {
		  ...
		  $this->load->view("template/header_web",$data);         
                        $this->load->view("stripe_web/my_stripe",$data);
                          $this->load->view("template/footer_web",$data); 
        	...
        	if (!$this->ion_auth->logged_in())
        {
            redirect('users/auth', 'refresh');
			 ...
			 $sess_id = $this->session->userdata('user_id');
                                    ...
                                    if(!empty($sess_id)){
                                        $cotis=$data['cotis'] = $this->stripe_model->user_cotisation_paye($user_id);
                                        
                                       // $data['cotis'] = $this->stripe_model->user_cotisation_paye($user_id);
                              $this->load->view("template/header_web",$data);         
                        $this->load->view("stripe_web/liste_user_coti",$data);
                          $this->load->view("template/footer_web",$data); 
                        //var_dump($cotis)
