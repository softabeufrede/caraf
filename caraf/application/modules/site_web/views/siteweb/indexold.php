...
<!-- /.mainmenu-area -->
			...
			<div class="row">
				<div class="col-md-3">
					<div class="welcome-content">
						<h2 class="welcome-title">A la une</h2>
						<p>Here are ways you can help. Some of the projects your donate can support</p>
					...
					<div class="row">
						<div class="col-sm-6 col-md-3 inner">
							<div class="welcome-project">
								<div class="thumb">
									<img src="<?php bs() ?>public/siteweb/img/projects/n1_1.jpg" alt="">
									<div class="overlay">
						...
						<div class="col-sm-6 col-md-3 inner">
							<div class="welcome-project">
								<div class="thumb">
									<img src="<?php bs() ?>public/siteweb/img/projects/n2_1.jpg" alt="">
									<div class="overlay">
										<a href="#">Je participe</a>
										<a href="#">En savoir plus</a>
									</div>
								...
								<div class="caption">
									<h4 class="title">Alimentation</h4>
									<p>Lorem ipsum dolor sit amet, consectetur adipisicing</p>
								</div>
							</div>
						</div>
						<div class="col-sm-6 col-md-3 inner">
							<div class="welcome-project">
								<div class="thumb">
									<img src="<?php bs() ?>public/siteweb/img/projects/n3_1.jpg" alt="">
									<div class="overlay">
										<a href="#">Je participe</a>
										<a href="#">En savoir plus</a>
									</div>
								...
								<div class="caption">
									<h4 class="title">Développement</h4>
									<p>Lorem ipsum dolor sit amet, consectetur adipisicing</p>
								</div>
							</div>
						</div>
						<div class="col-sm-6 col-md-3 inner">
							<div class="welcome-project">
								<div class="thumb">
									<img src="<?php bs() ?>public/siteweb/img/projects/n4_1.jpg" alt="">
									<div class="overlay">
										<a href="#">Je participe</a>
										<a href="#">En savoir plus</a>
									</div>
			...
			<div class="row causes-style">
	          <div class="col-sm-12 col-md-4 col-lg-4">
	            <div class="causes sm-col5-center">
	              <div class="thumb">
	                <img class="full-width" alt="" src="<?php bs() ?>public/siteweb/img/causes/n1.jpg">
	              </div>
	              <div class="causes-details clearfix">
	                <h4 class="title"><a href="#">Activités 1</a></h4>
	                <p>Lorem ipsum dolor sit amet, consectetur ambo elit. Numquam repellendus est rerum sed, read aliquid atup inventore, voluptate, eveniet, soluta nostrum sint.</p>
	                <div>
	                 <a href="#" class="thm-btn btn-xs"><i class="fa fa-angle-double-right text-white"></i> Je participe</a>
	                 <a class="thm-btn inverse btn-xs" href="#"><i class="fa fa-heart text-theme-colored"></i> 25 Donateurs</a>
	                </div>
	              </div>
	            </div>
	          </div>
	          <div class="col-sm-12 col-md-4 col-lg-4">
	            <div class="causes sm-col5-center">
	              <div class="thumb">
	                <img class="full-width" alt="" src="<?php bs() ?>public/siteweb/img/causes/n2.jpg">
	              </div>
	              <div class="causes-details clearfix">
	                <h4 class="title"><a href="#">Activités 2</a></h4>
	                <p>Lorem ipsum dolor sit amet, consectetur ambo elit. Numquam repellendus est rerum sed, read aliquid atup inventore, voluptate, eveniet, soluta nostrum sint.</p>
	                <div>
	                 <a href="#" class="thm-btn btn-xs"><i class="fa fa-angle-double-right text-white"></i> Je participe</a>
	                 <a class="thm-btn inverse btn-xs" href="#"><i class="fa fa-heart text-theme-colored"></i> 25 Donateurs</a>
	          ...
	          <div class="col-sm-12 col-md-4 col-lg-4">
	            <div class="causes sm-col5-center">
	              <div class="thumb">
	                <img class="full-width" alt="" src="<?php bs() ?>public/siteweb/img/causes/n3.jpg">
	              </div>
	              <div class="causes-details clearfix">
	                <h4 class="title"><a href="#">Activités 3</a></h4>
	                <p>Lorem ipsum dolor sit amet, consectetur ambo elit. Numquam repellendus est rerum sed, read aliquid atup inventore, voluptate, eveniet, soluta nostrum sint.</p>
	                <div>
	                 <a href="#" class="thm-btn btn-xs"><i class="fa fa-angle-double-right text-white"></i> Je participe</a>
	                 <a class="thm-btn inverse btn-xs" href="#"><i class="fa fa-heart text-theme-colored"></i> 25 Donateurs</a>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2 promote-project style-inner text-center">
					<h3>Sauvez les enfants du pays Akyé du manque d'éducation</h3>
					<div class="sec-title colored text-center">
						<span class="decor">
							<span class="inner"></span>
						</span>
					</div>
					<h2>EST DEVENU UNE LUTTE CONTINUE</h2>
				...
				<div class="col-md-3 col-sm-6">
					<div class="single-service-home">
						<div class="content">
							...
							<a class="btn-details" href="#">En savoir plus</a>
						</div>
					</div>
				</div>
				<div class="col-md-3 col-sm-6">
            ...
            <div class="filter-list clearfix">
                ...
                <div class="image-box mix mix_all child charity">
                    <div class="inner-box">
                        ...
                        <a href="<?php bs() ?>public/siteweb/img/gallery/n6.jpg"
                         class="lightbox-image btn-zoom" title="Image Title Here"><span class="icon fa fa-dot-circle-o"></span></a>
                    </div>
                </div>
                ...
                <div class="image-box mix mix_all child charity sponsorship volunteering">
                    <div class="inner-box">
                        ...
                        <a href="<?php bs() ?>public/siteweb/img/gallery/n7.jpg" class="lightbox-image btn-zoom"
                         title="Image Title Here"><span class="icon fa fa-dot-circle-o"></span></a>
                    </div>
                </div>
                ...
                <div class="image-box mix mix_all charity sponsorship volunteering">
                    <div class="inner-box">
                        <figure class="image"><a href="<?php bs() ?>public/siteweb/img/gallery/n8.jpg"
                         class="lightbox-image"><img src="<?php bs() ?>public/siteweb/img/gallery/n8.jpg" alt=""></a></figure>
                        <a href="<?php bs() ?>public/siteweb/img/gallery/n8.jpg" 
                        class="lightbox-image btn-zoom" title="Image Title Here"><span class="icon fa fa-dot-circle-o"></span></a>
                    </div>
                </div>
	...
	<section class="upcoming-event sec-padding bg-pattern bg-color-thm sec-padding75">
		<div class="container">
			<div class="row">
				<div class="col-xs-12">
					<div class="sec-title text-center">
						<h2 class="text-white">Activités futurs</h2>
						<p class="text-white">Parlons des projets et activités avenir</p>
						<span class="decor"><span class="inner"></span></span>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-md-4">
					<div class="event-post">
						<div class="thumb">
							<img src="<?php bs() ?>public/siteweb/img/event/actf.jpg" alt="">
							<div class="overlay">
								<a href="#">Nous réjoindre</a>
								<a href="#">Je participe</a>
							</div>
						</div>
						<div class="caption">
							<h3 class="title"><a href="#">Construction d'un centre Hospilatié</a></h3>
				...
				<div class="col-md-4">
					<div class="event-post">
						...
						<div class="caption">
							<h3 class="title"><a href="#">Réhabilitation urbaine</a></h3>
							<i class="fa fa-map-marker"></i>
							<p class="event-time"><span>16-25</span> June <span>2016</span></p>
							<p class="event-location">United Kingdom</p>
						</div>
				...
				<div class="col-md-4">
					<div class="event-post">
						...
						<div class="caption">
							<h3 class="title"><a href="#">Construction d'un Complexe sportif</a></h3>
							<i class="fa fa-map-marker"></i>
							<p class="event-time"><span>16-25</span> June <span>2016</span></p>
							<p class="event-location">United Kingdom</p>
						</div>
				...
				<div class="team-carousel owl-carousel owl-theme">
					<div class="item">
						<div class="single-team-member">
							<div class="img-box">
								<img src="<?php bs() ?>public/siteweb/img/team/1_1.jpg" alt="">
								<div class="overlay">
									<div class="box">
										<div class="content">
											<ul>
			...
			<div class="row">
				<div class="col-md-4 col-sm-12 blogs-inner">
					<div class="single-blog-post">
						<div class="img-box">
							<img class="full-width" src="<?php bs() ?>public/siteweb/img/blog/1.jpg" alt="">
							<div class="overlay">
								<div class="box">
									<div class="content">
										<ul>
	...
	<!-- main jQuery -->
	<script src="<?php bs() ?>public/siteweb/js/jquery-1.11.1.min.js"></script>
	<!-- bootstrap -->
	<script src="<?php bs() ?>public/siteweb/js/bootstrap.min.js"></script>
	<!-- bx slider -->
	<script src="<?php bs() ?>public/siteweb/js/jquery.bxslider.min.js"></script>
	<!-- owl carousel -->
	<script src="<?php bs() ?>public/siteweb/js/owl.carousel.min.js"></script>
	<!-- validate -->
	<script src="<?php bs() ?>public/siteweb/js/jquery-parallax.js"></script>
	<!-- validate -->
	<script src="<?php bs() ?>public/siteweb/js/validate.js"></script>
	<!-- mixit up -->
	<script src="<?php bs() ?>public/siteweb/js/jquery.mixitup.min.js"></script>
	<!-- fancybox -->
	<script src="<?php bs() ?>public/siteweb/js/jquery.fancybox.pack.js"></script>
	<!-- easing -->
	<script src="<?php bs() ?>public/siteweb/js/jquery.easing.min.js"></script>
	<!-- circle progress -->
	<script src="<?php bs() ?>public/siteweb/js/circle-progress.js"></script>
	<!-- appear js -->
	<script src="<?php bs() ?>public/siteweb/js/jquery.appear.js"></script>
	<!-- count to -->
	<script src="<?php bs() ?>public/siteweb/js/jquery.countTo.js"></script>

	<!-- isotope script -->
	<script src="<?php bs() ?>public/siteweb/js/isotope.pkgd.min.js"></script>
	<!-- jQuery ui js -->
	<script src="<?php bs() ?>public/siteweb/js/jquery-ui-1.11.4/jquery-ui.js"></script>
	
	<!-- revolution scripts -->

	<script src="<?php bs() ?>public/siteweb/revolution/js/jquery.themepunch.tools.min.js"></script>
	<script src="<?php bs() ?>public/siteweb/revolution/js/jquery.themepunch.revolution.min.js"></script>
	<script type="text/javascript" src="<?php bs() ?>public/siteweb/revolution/js/extensions/revolution.extension.actions.min.js"></script>
	<script type="text/javascript" src="<?php bs() ?>public/siteweb/revolution/js/extensions/revolution.extension.carousel.min.js"></script>
	<script type="text/javascript" src="<?php bs() ?>public/siteweb/revolution/js/extensions/revolution.extension.kenburn.min.js"></script>
	<script type="text/javascript" src="<?php bs() ?>public/siteweb/revolution/js/extensions/revolution.extension.layeranimation.min.js"></script>
	<script type="text/javascript" src="<?php bs() ?>public/siteweb/revolution/js/extensions/revolution.extension.migration.min.js"></script>
	<script type="text/javascript" src="<?php bs() ?>public/siteweb/revolution/js/extensions/revolution.extension.navigation.min.js"></script>
	<script type="text/javascript" src="<?php bs() ?>public/siteweb/revolution/js/extensions/revolution.extension.parallax.min.js"></script>
	<script type="text/javascript" src="<?php bs() ?>public/siteweb/revolution/js/extensions/revolution.extension.slideanims.min.js"></script>
	<script type="text/javascript" src="<?php bs() ?>public/siteweb/revolution/js/extensions/revolution.extension.video.min.js"></script>
